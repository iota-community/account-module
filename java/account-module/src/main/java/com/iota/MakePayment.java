...
class MakePayment {
    public static void main(String[] args) throws ArgumentException, InterruptedException, ExecutionException {
        ...
        String magnet = "iota://OMCMJBY9APQQKJTDYLSW9MIUUHBDESEQIWEGRCBJCKKUMNPWIKEDJBXW9ROEKPRYENFGLFTFYZKPKBMMWTFYCVNOB9/?timeout_at=1575745907637&multi_use=true&expected_amount=0";
